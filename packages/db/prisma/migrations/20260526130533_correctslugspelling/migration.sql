/*
  ...
  - You are about to drop the column `slud` on the `Room` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "Room_slud_key";

-- AlterTable
ALTER TABLE "Room" DROP COLUMN "slud",
